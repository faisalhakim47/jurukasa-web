...
//#endregion
//#region node_modules/@libsql/client-wasm/node_modules/@libsql/libsql-wasm-experimental/sqlite-wasm/jswasm/sqlite3-bundler-friendly.mjs
var sqlite3InitModule = (() => {
	...
	return (function(moduleArg = {}) {
		...
		} else wasmBinaryFile = new URL("sqlite3.wasm", import.meta.url).href;
			...
			ensureErrnoError() {
				...
				FS.ErrnoError = function ErrnoError(errno, node) {
					...
					this.setErrno = function(errno$1) {
						this.errno = errno$1;
						for (var key in ERRNO_CODES) if (ERRNO_CODES[key] === errno$1) {
							this.code = key;
							break;
						}
					};
					...
					if (this.stack) {
						Object.defineProperty(this, "stack", {
							value: (/* @__PURE__ */ new Error()).stack,
							writable: true
						});
		...
		Module["_sqlite3_status64"] = createExportWrapper("sqlite3_status64");
		Module["_sqlite3_status"] = createExportWrapper("sqlite3_status");
		Module["_sqlite3_db_status"] = createExportWrapper("sqlite3_db_status");
		Module["_sqlite3_msize"] = createExportWrapper("sqlite3_msize");
		Module["_sqlite3_vfs_find"] = createExportWrapper("sqlite3_vfs_find");
		Module["_sqlite3_initialize"] = createExportWrapper("sqlite3_initialize");
		Module["_sqlite3_vfs_register"] = createExportWrapper("sqlite3_vfs_register");
		Module["_sqlite3_vfs_unregister"] = createExportWrapper("sqlite3_vfs_unregister");
		Module["_sqlite3_malloc"] = createExportWrapper("sqlite3_malloc");
		Module["_sqlite3_malloc64"] = createExportWrapper("sqlite3_malloc64");
		Module["_sqlite3_free"] = createExportWrapper("sqlite3_free");
		Module["_sqlite3_realloc"] = createExportWrapper("sqlite3_realloc");
		Module["_sqlite3_realloc64"] = createExportWrapper("sqlite3_realloc64");
		Module["_sqlite3_value_int64"] = createExportWrapper("sqlite3_value_int64");
		Module["_sqlite3_value_double"] = createExportWrapper("sqlite3_value_double");
		Module["_sqlite3_value_text"] = createExportWrapper("sqlite3_value_text");
		Module["_sqlite3_randomness"] = createExportWrapper("sqlite3_randomness");
		Module["_sqlite3_stricmp"] = createExportWrapper("sqlite3_stricmp");
		Module["_sqlite3_strnicmp"] = createExportWrapper("sqlite3_strnicmp");
		var ___errno_location = createExportWrapper("__errno_location");
		Module["_sqlite3_serialize"] = createExportWrapper("sqlite3_serialize");
		Module["_sqlite3_prepare_v2"] = createExportWrapper("sqlite3_prepare_v2");
		Module["_sqlite3_step"] = createExportWrapper("sqlite3_step");
		Module["_sqlite3_column_int64"] = createExportWrapper("sqlite3_column_int64");
		Module["_sqlite3_column_int"] = createExportWrapper("sqlite3_column_int");
		Module["_sqlite3_finalize"] = createExportWrapper("sqlite3_finalize");
		Module["_sqlite3_file_control"] = createExportWrapper("sqlite3_file_control");
		Module["_sqlite3_reset"] = createExportWrapper("sqlite3_reset");
		Module["_sqlite3_value_int"] = createExportWrapper("sqlite3_value_int");
		Module["_sqlite3_deserialize"] = createExportWrapper("sqlite3_deserialize");
		Module["_sqlite3_clear_bindings"] = createExportWrapper("sqlite3_clear_bindings");
		Module["_sqlite3_value_blob"] = createExportWrapper("sqlite3_value_blob");
		Module["_sqlite3_value_bytes"] = createExportWrapper("sqlite3_value_bytes");
		Module["_sqlite3_value_subtype"] = createExportWrapper("sqlite3_value_subtype");
		Module["_sqlite3_value_pointer"] = createExportWrapper("sqlite3_value_pointer");
		Module["_sqlite3_value_type"] = createExportWrapper("sqlite3_value_type");
		Module["_sqlite3_value_nochange"] = createExportWrapper("sqlite3_value_nochange");
		Module["_sqlite3_value_frombind"] = createExportWrapper("sqlite3_value_frombind");
		Module["_sqlite3_value_dup"] = createExportWrapper("sqlite3_value_dup");
		Module["_sqlite3_value_free"] = createExportWrapper("sqlite3_value_free");
		Module["_sqlite3_result_blob"] = createExportWrapper("sqlite3_result_blob");
		Module["_sqlite3_result_error_toobig"] = createExportWrapper("sqlite3_result_error_toobig");
		Module["_sqlite3_result_error_nomem"] = createExportWrapper("sqlite3_result_error_nomem");
		Module["_sqlite3_result_double"] = createExportWrapper("sqlite3_result_double");
		Module["_sqlite3_result_error"] = createExportWrapper("sqlite3_result_error");
		Module["_sqlite3_result_int"] = createExportWrapper("sqlite3_result_int");
		Module["_sqlite3_result_int64"] = createExportWrapper("sqlite3_result_int64");
		Module["_sqlite3_result_null"] = createExportWrapper("sqlite3_result_null");
		Module["_sqlite3_result_pointer"] = createExportWrapper("sqlite3_result_pointer");
		Module["_sqlite3_result_subtype"] = createExportWrapper("sqlite3_result_subtype");
		Module["_sqlite3_result_text"] = createExportWrapper("sqlite3_result_text");
		Module["_sqlite3_result_zeroblob"] = createExportWrapper("sqlite3_result_zeroblob");
		Module["_sqlite3_result_zeroblob64"] = createExportWrapper("sqlite3_result_zeroblob64");
		Module["_sqlite3_result_error_code"] = createExportWrapper("sqlite3_result_error_code");
		Module["_sqlite3_sql"] = createExportWrapper("sqlite3_sql");
		Module["_sqlite3_user_data"] = createExportWrapper("sqlite3_user_data");
		Module["_sqlite3_context_db_handle"] = createExportWrapper("sqlite3_context_db_handle");
		Module["_sqlite3_vtab_nochange"] = createExportWrapper("sqlite3_vtab_nochange");
		Module["_sqlite3_vtab_in_first"] = createExportWrapper("sqlite3_vtab_in_first");
		Module["_sqlite3_vtab_in_next"] = createExportWrapper("sqlite3_vtab_in_next");
		Module["_sqlite3_aggregate_context"] = createExportWrapper("sqlite3_aggregate_context");
		Module["_sqlite3_get_auxdata"] = createExportWrapper("sqlite3_get_auxdata");
		Module["_sqlite3_set_auxdata"] = createExportWrapper("sqlite3_set_auxdata");
		Module["_sqlite3_column_count"] = createExportWrapper("sqlite3_column_count");
		Module["_sqlite3_data_count"] = createExportWrapper("sqlite3_data_count");
		Module["_sqlite3_column_blob"] = createExportWrapper("sqlite3_column_blob");
		Module["_sqlite3_column_bytes"] = createExportWrapper("sqlite3_column_bytes");
		Module["_sqlite3_column_double"] = createExportWrapper("sqlite3_column_double");
		Module["_sqlite3_column_text"] = createExportWrapper("sqlite3_column_text");
		Module["_sqlite3_column_value"] = createExportWrapper("sqlite3_column_value");
		Module["_sqlite3_column_type"] = createExportWrapper("sqlite3_column_type");
		Module["_sqlite3_column_name"] = createExportWrapper("sqlite3_column_name");
		Module["_sqlite3_bind_blob"] = createExportWrapper("sqlite3_bind_blob");
		Module["_sqlite3_bind_double"] = createExportWrapper("sqlite3_bind_double");
		Module["_sqlite3_bind_int"] = createExportWrapper("sqlite3_bind_int");
		Module["_sqlite3_bind_int64"] = createExportWrapper("sqlite3_bind_int64");
		Module["_sqlite3_bind_null"] = createExportWrapper("sqlite3_bind_null");
		Module["_sqlite3_bind_pointer"] = createExportWrapper("sqlite3_bind_pointer");
		Module["_sqlite3_bind_text"] = createExportWrapper("sqlite3_bind_text");
		Module["_sqlite3_bind_parameter_count"] = createExportWrapper("sqlite3_bind_parameter_count");
		Module["_sqlite3_bind_parameter_index"] = createExportWrapper("sqlite3_bind_parameter_index");
		Module["_sqlite3_db_handle"] = createExportWrapper("sqlite3_db_handle");
		Module["_sqlite3_stmt_readonly"] = createExportWrapper("sqlite3_stmt_readonly");
		Module["_sqlite3_stmt_isexplain"] = createExportWrapper("sqlite3_stmt_isexplain");
		Module["_sqlite3_stmt_status"] = createExportWrapper("sqlite3_stmt_status");
		Module["_sqlite3_expanded_sql"] = createExportWrapper("sqlite3_expanded_sql");
		Module["_sqlite3_preupdate_old"] = createExportWrapper("sqlite3_preupdate_old");
		Module["_sqlite3_preupdate_count"] = createExportWrapper("sqlite3_preupdate_count");
		Module["_sqlite3_preupdate_depth"] = createExportWrapper("sqlite3_preupdate_depth");
		Module["_sqlite3_preupdate_blobwrite"] = createExportWrapper("sqlite3_preupdate_blobwrite");
		Module["_sqlite3_preupdate_new"] = createExportWrapper("sqlite3_preupdate_new");
		Module["_sqlite3_value_numeric_type"] = createExportWrapper("sqlite3_value_numeric_type");
		Module["_sqlite3_errmsg"] = createExportWrapper("sqlite3_errmsg");
		Module["_sqlite3_set_authorizer"] = createExportWrapper("sqlite3_set_authorizer");
		Module["_sqlite3_strglob"] = createExportWrapper("sqlite3_strglob");
		Module["_sqlite3_strlike"] = createExportWrapper("sqlite3_strlike");
		Module["_sqlite3_exec"] = createExportWrapper("sqlite3_exec");
		Module["_sqlite3_auto_extension"] = createExportWrapper("sqlite3_auto_extension");
		Module["_sqlite3_cancel_auto_extension"] = createExportWrapper("sqlite3_cancel_auto_extension");
		Module["_sqlite3_reset_auto_extension"] = createExportWrapper("sqlite3_reset_auto_extension");
		Module["_sqlite3_prepare_v3"] = createExportWrapper("sqlite3_prepare_v3");
		Module["_sqlite3_create_module"] = createExportWrapper("sqlite3_create_module");
		Module["_sqlite3_create_module_v2"] = createExportWrapper("sqlite3_create_module_v2");
		Module["_sqlite3_drop_modules"] = createExportWrapper("sqlite3_drop_modules");
		Module["_sqlite3_declare_vtab"] = createExportWrapper("sqlite3_declare_vtab");
		Module["_sqlite3_vtab_on_conflict"] = createExportWrapper("sqlite3_vtab_on_conflict");
		Module["_sqlite3_vtab_collation"] = createExportWrapper("sqlite3_vtab_collation");
		Module["_sqlite3_vtab_in"] = createExportWrapper("sqlite3_vtab_in");
		Module["_sqlite3_vtab_rhs_value"] = createExportWrapper("sqlite3_vtab_rhs_value");
		Module["_sqlite3_vtab_distinct"] = createExportWrapper("sqlite3_vtab_distinct");
		Module["_sqlite3_keyword_name"] = createExportWrapper("sqlite3_keyword_name");
		Module["_sqlite3_keyword_count"] = createExportWrapper("sqlite3_keyword_count");
		Module["_sqlite3_keyword_check"] = createExportWrapper("sqlite3_keyword_check");
		Module["_sqlite3_complete"] = createExportWrapper("sqlite3_complete");
		Module["_sqlite3_libversion"] = createExportWrapper("sqlite3_libversion");
		Module["_sqlite3_libversion_number"] = createExportWrapper("sqlite3_libversion_number");
		Module["_sqlite3_shutdown"] = createExportWrapper("sqlite3_shutdown");
		Module["_sqlite3_last_insert_rowid"] = createExportWrapper("sqlite3_last_insert_rowid");
		Module["_sqlite3_set_last_insert_rowid"] = createExportWrapper("sqlite3_set_last_insert_rowid");
		Module["_sqlite3_changes64"] = createExportWrapper("sqlite3_changes64");
		Module["_sqlite3_changes"] = createExportWrapper("sqlite3_changes");
		Module["_sqlite3_total_changes64"] = createExportWrapper("sqlite3_total_changes64");
		Module["_sqlite3_total_changes"] = createExportWrapper("sqlite3_total_changes");
		Module["_sqlite3_txn_state"] = createExportWrapper("sqlite3_txn_state");
		Module["_sqlite3_close_v2"] = createExportWrapper("sqlite3_close_v2");
		Module["_sqlite3_busy_handler"] = createExportWrapper("sqlite3_busy_handler");
		Module["_sqlite3_progress_handler"] = createExportWrapper("sqlite3_progress_handler");
		Module["_sqlite3_busy_timeout"] = createExportWrapper("sqlite3_busy_timeout");
		Module["_sqlite3_create_function"] = createExportWrapper("sqlite3_create_function");
		Module["_sqlite3_create_function_v2"] = createExportWrapper("sqlite3_create_function_v2");
		Module["_sqlite3_create_window_function"] = createExportWrapper("sqlite3_create_window_function");
		Module["_sqlite3_overload_function"] = createExportWrapper("sqlite3_overload_function");
		Module["_sqlite3_trace_v2"] = createExportWrapper("sqlite3_trace_v2");
		Module["_sqlite3_commit_hook"] = createExportWrapper("sqlite3_commit_hook");
		Module["_sqlite3_update_hook"] = createExportWrapper("sqlite3_update_hook");
		Module["_sqlite3_rollback_hook"] = createExportWrapper("sqlite3_rollback_hook");
		Module["_sqlite3_preupdate_hook"] = createExportWrapper("sqlite3_preupdate_hook");
		Module["_sqlite3_error_offset"] = createExportWrapper("sqlite3_error_offset");
		Module["_sqlite3_errcode"] = createExportWrapper("sqlite3_errcode");
		Module["_sqlite3_extended_errcode"] = createExportWrapper("sqlite3_extended_errcode");
		Module["_sqlite3_errstr"] = createExportWrapper("sqlite3_errstr");
		Module["_sqlite3_limit"] = createExportWrapper("sqlite3_limit");
		Module["_sqlite3_open"] = createExportWrapper("sqlite3_open");
		Module["_sqlite3_open_v2"] = createExportWrapper("sqlite3_open_v2");
		Module["_sqlite3_create_collation"] = createExportWrapper("sqlite3_create_collation");
		Module["_sqlite3_create_collation_v2"] = createExportWrapper("sqlite3_create_collation_v2");
		Module["_sqlite3_collation_needed"] = createExportWrapper("sqlite3_collation_needed");
		Module["_sqlite3_get_autocommit"] = createExportWrapper("sqlite3_get_autocommit");
		Module["_sqlite3_table_column_metadata"] = createExportWrapper("sqlite3_table_column_metadata");
		Module["_sqlite3_extended_result_codes"] = createExportWrapper("sqlite3_extended_result_codes");
		Module["_sqlite3_uri_parameter"] = createExportWrapper("sqlite3_uri_parameter");
		Module["_sqlite3_uri_key"] = createExportWrapper("sqlite3_uri_key");
		Module["_sqlite3_uri_boolean"] = createExportWrapper("sqlite3_uri_boolean");
		Module["_sqlite3_uri_int64"] = createExportWrapper("sqlite3_uri_int64");
		Module["_sqlite3_db_name"] = createExportWrapper("sqlite3_db_name");
		Module["_sqlite3_db_filename"] = createExportWrapper("sqlite3_db_filename");
		Module["_sqlite3_compileoption_used"] = createExportWrapper("sqlite3_compileoption_used");
		Module["_sqlite3_compileoption_get"] = createExportWrapper("sqlite3_compileoption_get");
		Module["_sqlite3session_diff"] = createExportWrapper("sqlite3session_diff");
		Module["_sqlite3session_attach"] = createExportWrapper("sqlite3session_attach");
		Module["_sqlite3session_create"] = createExportWrapper("sqlite3session_create");
		Module["_sqlite3session_delete"] = createExportWrapper("sqlite3session_delete");
		Module["_sqlite3session_table_filter"] = createExportWrapper("sqlite3session_table_filter");
		Module["_sqlite3session_changeset"] = createExportWrapper("sqlite3session_changeset");
		Module["_sqlite3session_changeset_strm"] = createExportWrapper("sqlite3session_changeset_strm");
		Module["_sqlite3session_patchset_strm"] = createExportWrapper("sqlite3session_patchset_strm");
		Module["_sqlite3session_patchset"] = createExportWrapper("sqlite3session_patchset");
		Module["_sqlite3session_enable"] = createExportWrapper("sqlite3session_enable");
		Module["_sqlite3session_indirect"] = createExportWrapper("sqlite3session_indirect");
		Module["_sqlite3session_isempty"] = createExportWrapper("sqlite3session_isempty");
		Module["_sqlite3session_memory_used"] = createExportWrapper("sqlite3session_memory_used");
		Module["_sqlite3session_object_config"] = createExportWrapper("sqlite3session_object_config");
		Module["_sqlite3session_changeset_size"] = createExportWrapper("sqlite3session_changeset_size");
		Module["_sqlite3changeset_start"] = createExportWrapper("sqlite3changeset_start");
		Module["_sqlite3changeset_start_v2"] = createExportWrapper("sqlite3changeset_start_v2");
		Module["_sqlite3changeset_start_strm"] = createExportWrapper("sqlite3changeset_start_strm");
		Module["_sqlite3changeset_start_v2_strm"] = createExportWrapper("sqlite3changeset_start_v2_strm");
		Module["_sqlite3changeset_next"] = createExportWrapper("sqlite3changeset_next");
		Module["_sqlite3changeset_op"] = createExportWrapper("sqlite3changeset_op");
		Module["_sqlite3changeset_pk"] = createExportWrapper("sqlite3changeset_pk");
		Module["_sqlite3changeset_old"] = createExportWrapper("sqlite3changeset_old");
		Module["_sqlite3changeset_new"] = createExportWrapper("sqlite3changeset_new");
		Module["_sqlite3changeset_conflict"] = createExportWrapper("sqlite3changeset_conflict");
		Module["_sqlite3changeset_fk_conflicts"] = createExportWrapper("sqlite3changeset_fk_conflicts");
		Module["_sqlite3changeset_finalize"] = createExportWrapper("sqlite3changeset_finalize");
		Module["_sqlite3changeset_invert"] = createExportWrapper("sqlite3changeset_invert");
		Module["_sqlite3changeset_invert_strm"] = createExportWrapper("sqlite3changeset_invert_strm");
		Module["_sqlite3changeset_apply_v2"] = createExportWrapper("sqlite3changeset_apply_v2");
		Module["_sqlite3changeset_apply"] = createExportWrapper("sqlite3changeset_apply");
		Module["_sqlite3changeset_apply_v2_strm"] = createExportWrapper("sqlite3changeset_apply_v2_strm");
		Module["_sqlite3changeset_apply_strm"] = createExportWrapper("sqlite3changeset_apply_strm");
		Module["_sqlite3changegroup_new"] = createExportWrapper("sqlite3changegroup_new");
		Module["_sqlite3changegroup_add"] = createExportWrapper("sqlite3changegroup_add");
		Module["_sqlite3changegroup_output"] = createExportWrapper("sqlite3changegroup_output");
		Module["_sqlite3changegroup_add_strm"] = createExportWrapper("sqlite3changegroup_add_strm");
		Module["_sqlite3changegroup_output_strm"] = createExportWrapper("sqlite3changegroup_output_strm");
		Module["_sqlite3changegroup_delete"] = createExportWrapper("sqlite3changegroup_delete");
		Module["_sqlite3changeset_concat"] = createExportWrapper("sqlite3changeset_concat");
		Module["_sqlite3changeset_concat_strm"] = createExportWrapper("sqlite3changeset_concat_strm");
		Module["_sqlite3session_config"] = createExportWrapper("sqlite3session_config");
		Module["_sqlite3_sourceid"] = createExportWrapper("sqlite3_sourceid");
		Module["_sqlite3_wasm_pstack_ptr"] = createExportWrapper("sqlite3_wasm_pstack_ptr");
		Module["_sqlite3_wasm_pstack_restore"] = createExportWrapper("sqlite3_wasm_pstack_restore");
		Module["_sqlite3_wasm_pstack_alloc"] = createExportWrapper("sqlite3_wasm_pstack_alloc");
		Module["_sqlite3_wasm_pstack_remaining"] = createExportWrapper("sqlite3_wasm_pstack_remaining");
		Module["_sqlite3_wasm_pstack_quota"] = createExportWrapper("sqlite3_wasm_pstack_quota");
		Module["_sqlite3_wasm_db_error"] = createExportWrapper("sqlite3_wasm_db_error");
		Module["_sqlite3_wasm_test_struct"] = createExportWrapper("sqlite3_wasm_test_struct");
		Module["_sqlite3_wasm_enum_json"] = createExportWrapper("sqlite3_wasm_enum_json");
		Module["_sqlite3_wasm_vfs_unlink"] = createExportWrapper("sqlite3_wasm_vfs_unlink");
		Module["_sqlite3_wasm_db_vfs"] = createExportWrapper("sqlite3_wasm_db_vfs");
		Module["_sqlite3_wasm_db_reset"] = createExportWrapper("sqlite3_wasm_db_reset");
		Module["_sqlite3_wasm_db_export_chunked"] = createExportWrapper("sqlite3_wasm_db_export_chunked");
		Module["_sqlite3_wasm_db_serialize"] = createExportWrapper("sqlite3_wasm_db_serialize");
		Module["_sqlite3_wasm_vfs_create_file"] = createExportWrapper("sqlite3_wasm_vfs_create_file");
		Module["_sqlite3_wasm_posix_create_file"] = createExportWrapper("sqlite3_wasm_posix_create_file");
		Module["_sqlite3_wasm_kvvfsMakeKeyOnPstack"] = createExportWrapper("sqlite3_wasm_kvvfsMakeKeyOnPstack");
		Module["_sqlite3_wasm_kvvfs_methods"] = createExportWrapper("sqlite3_wasm_kvvfs_methods");
		Module["_sqlite3_wasm_vtab_config"] = createExportWrapper("sqlite3_wasm_vtab_config");
		Module["_sqlite3_wasm_db_config_ip"] = createExportWrapper("sqlite3_wasm_db_config_ip");
		Module["_sqlite3_wasm_db_config_pii"] = createExportWrapper("sqlite3_wasm_db_config_pii");
		Module["_sqlite3_wasm_db_config_s"] = createExportWrapper("sqlite3_wasm_db_config_s");
		Module["_sqlite3_wasm_config_i"] = createExportWrapper("sqlite3_wasm_config_i");
		Module["_sqlite3_wasm_config_ii"] = createExportWrapper("sqlite3_wasm_config_ii");
		Module["_sqlite3_wasm_config_j"] = createExportWrapper("sqlite3_wasm_config_j");
		Module["_sqlite3_wasm_init_wasmfs"] = createExportWrapper("sqlite3_wasm_init_wasmfs");
		Module["_sqlite3_wasm_test_intptr"] = createExportWrapper("sqlite3_wasm_test_intptr");
		Module["_sqlite3_wasm_test_voidptr"] = createExportWrapper("sqlite3_wasm_test_voidptr");
		Module["_sqlite3_wasm_test_int64_max"] = createExportWrapper("sqlite3_wasm_test_int64_max");
		Module["_sqlite3_wasm_test_int64_min"] = createExportWrapper("sqlite3_wasm_test_int64_min");
		Module["_sqlite3_wasm_test_int64_times2"] = createExportWrapper("sqlite3_wasm_test_int64_times2");
		Module["_sqlite3_wasm_test_int64_minmax"] = createExportWrapper("sqlite3_wasm_test_int64_minmax");
		Module["_sqlite3_wasm_test_int64ptr"] = createExportWrapper("sqlite3_wasm_test_int64ptr");
		Module["_sqlite3_wasm_test_stack_overflow"] = createExportWrapper("sqlite3_wasm_test_stack_overflow");
		Module["_sqlite3_wasm_test_str_hello"] = createExportWrapper("sqlite3_wasm_test_str_hello");
		Module["_sqlite3_wasm_SQLTester_strglob"] = createExportWrapper("sqlite3_wasm_SQLTester_strglob");
		...
		Module.postRun.push(function(Module$1) {
			"use strict";
			"use strict";
			globalThis.sqlite3ApiBootstrap = function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
				...
				const config = Object.assign(Object.create(null), {
					...
					memory: void 0,
					bigIntEnabled: (() => {
						if ("undefined" !== typeof Module$1) return !!Module$1.HEAPU64;
				...
				};
				{
					...
					const keyDealloc = config.deallocExportName;
					const keyRealloc = config.reallocExportName;
					for (const key of [
						keyAlloc,
						keyDealloc,
						keyRealloc
				...
				capi.sqlite3_wasmfs_opfs_dir = function() {
					...
					try {
						if (pdir && 0 === wasm.xCallWrapped("sqlite3_wasm_init_wasmfs", "i32", ["string"], pdir)) return __wasmfsOpfsDir = pdir;
				...
				capi.sqlite3_js_db_export = function(pDb$1, schema = 0) {
					...
					try {
						...
						let rc = wasm.exports.sqlite3_wasm_db_serialize(pDb$1, zSchema, ppOut, pSize, 0);
						if (rc) toss3("Database serialization failed with code", sqlite3$1.capi.sqlite3_js_rc_str(rc));
				...
				capi.sqlite3_db_config = function(pDb$1, op, ...args) {
					...
					switch (op) {
						...
						case capi.SQLITE_DBCONFIG_REVERSE_SCANORDER: return this.ip(pDb$1, op, args[0], args[1] || 0);
						case capi.SQLITE_DBCONFIG_LOOKASIDE: return this.pii(pDb$1, op, args[0], args[1], args[2]);
						case capi.SQLITE_DBCONFIG_MAINDBNAME: return this.s(pDb$1, op, args[0]);
				...
				capi.sqlite3_value_to_js = function(pVal, throwIfCannotConvert = true) {
					...
					switch (valType) {
						...
						case capi.SQLITE_BLOB: {
							...
							if (n && !pBlob) sqlite3$1.WasmAllocError.toss("Cannot allocate memory for blob argument of", n, "byte(s)");
				...
				const sqlite3$1 = {
					...
					asyncPostInit: async function ff() {
						...
						const postInit = async () => {
							if (!sqlite3$1.__isUnderTest) {
								delete sqlite3$1.util;
								delete sqlite3$1.StructBinder;
							}
							return sqlite3$1;
						};
						const catcher = (e) => {
						...
						lia = lia.map((f) => {
							return f instanceof Function ? async (x) => f(sqlite3$1) : f;
						});
						lia.push(postInit);
						let p = Promise.resolve(sqlite3$1);
				...
				sqlite3ApiBootstrap.sqlite3 = sqlite3$1;
				return sqlite3$1;
			};
			...
			globalThis.WhWasmUtilInstaller = function(target) {
				...
				const xResult = cache.xWrap.convert.result;
			...
			globalThis.Jaccwabyt = function StructBinderFactory(config) {
				...
				const bigIntEnabled = void 0 === config.bigIntEnabled ? !!globalThis["BigInt64Array"] : !!config.bigIntEnabled;
				const BigInt$1 = globalThis["BigInt"];
				const BigInt64Array$1 = globalThis["BigInt64Array"];
				...
				const makeMemberWrapper = function f(ctor, name, descr) {
					if (!f._) {
						...
						const rxSig2 = /^[vipPsjfdcC]\([ipPsjfdcC]*\)$/;
			...
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3$1) {
				"use strict";
				const toss = (...args) => {
					throw new Error(args.join(" "));
				};
				sqlite3$1.SQLite3Error.toss;
				const capi = sqlite3$1.capi;
				const wasm = sqlite3$1.wasm;
				const util = sqlite3$1.util;
				...
				if (wasm.exports.sqlite3_activate_see instanceof Function) wasm.bindingSignatures.push([
					"sqlite3_key",
					"int",
					"sqlite3*",
					"string",
				...
				sqlite3$1.StructBinder = globalThis.Jaccwabyt({
					heap: wasm.heap8u,
					alloc: wasm.alloc,
				...
				delete globalThis.Jaccwabyt;
				{
					...
					wasm.xWrap.argAdapter("sqlite3_filename", __xArgPtr)("sqlite3_context*", __xArgPtr)("sqlite3_value*", __xArgPtr)("void*", __xArgPtr)("sqlite3_changegroup*", __xArgPtr)("sqlite3_changeset_iter*", __xArgPtr)("sqlite3_session*", __xArgPtr)("sqlite3_stmt*", (v$1) => __xArgPtr(v$1 instanceof (sqlite3$1?.oo1?.Stmt || nilType) ? v$1.pointer : v$1))("sqlite3*", (v$1) => __xArgPtr(v$1 instanceof (sqlite3$1?.oo1?.DB || nilType) ? v$1.pointer : v$1))("sqlite3_index_info*", (v$1) => __xArgPtr(v$1 instanceof (capi.sqlite3_index_info || nilType) ? v$1.pointer : v$1))("sqlite3_module*", (v$1) => __xArgPtr(v$1 instanceof (capi.sqlite3_module || nilType) ? v$1.pointer : v$1))("sqlite3_vfs*", (v$1) => {
						if ("string" === typeof v$1) return capi.sqlite3_vfs_find(v$1) || sqlite3$1.SQLite3Error.toss(capi.SQLITE_NOTFOUND, "Unknown sqlite3_vfs name:", v$1);
					...
					if (0 === wasm.exports.sqlite3_step.length) {
						...
						sqlite3$1.config.warn("Disabling sqlite3.wasm.xWrap.doArgcCheck due to environmental quirks.");
					}
					for (const e of wasm.bindingSignatures) capi[e[0]] = wasm.xWrap.apply(null, e);
					for (const e of wasm.bindingSignatures.wasm) wasm[e[0]] = wasm.xWrap.apply(null, e);
					...
					if (wasm.exports.sqlite3_wasm_db_error) {
						...
						util.sqlite3_wasm_db_error = function(pDb$1, resultCode, message) {
							if (resultCode instanceof sqlite3$1.WasmAllocError) {
					...
					} else util.sqlite3_wasm_db_error = function(pDb$1, errCode, msg) {
				...
				}
				{
					...
					if (!cJson) toss("Maintenance required: increase sqlite3_wasm_enum_json()'s", "static buffer size!");
					...
					for (const s of wasm.ctype.structs) if (!notThese[s.name]) capi[s.name] = sqlite3$1.StructBinder(s);
				...
				const __dbArgcMismatch = (pDb$1, f, n) => {
					return util.sqlite3_wasm_db_error(pDb$1, capi.SQLITE_MISUSE, f + "() requires " + n + " argument" + (1 === n ? "" : "s") + ".");
				};
				const __errEncoding = (pDb$1) => {
					return util.sqlite3_wasm_db_error(pDb$1, capi.SQLITE_FORMAT, "SQLITE_UTF8 is the only supported encoding.");
				};
				...
				__dbCleanupMap.addWindowFunc = function(pDb$1, name, arity) {
					const m = __dbCleanupMap(pDb$1, 1);
				...
				}
				{
					...
					capi.sqlite3_create_collation_v2 = function(pDb$1, zName, eTextRep, pArg, xCompare, xDestroy) {
						...
						try {
							...
							return util.sqlite3_wasm_db_error(pDb$1, e);
						}
					};
				...
				}
				{
					...
					capi.sqlite3_create_function_v2 = function f(pDb$1, funcName, nArg, eTextRep, pApp, xFunc, xStep, xFinal, xDestroy) {
						...
						try {
							...
							return util.sqlite3_wasm_db_error(pDb$1, e, "Creation of UDF threw: " + e);
						}
					};
					...
					capi.sqlite3_create_window_function = function f(pDb$1, funcName, nArg, eTextRep, pApp, xStep, xFinal, xValue, xInverse, xDestroy) {
				...
				}
				{
					...
					capi.sqlite3_prepare_v3 = function f(pDb$1, sql, sqlLen, prepFlags, ppStmt, pzTail) {
						...
						switch (typeof xSql) {
							...
							default: return util.sqlite3_wasm_db_error(pDb$1, capi.SQLITE_MISUSE, "Invalid SQL argument type for sqlite3_prepare_v2/v3().");
						}
					};
				...
				}
				{
					...
					capi.sqlite3_bind_text = function f(pStmt, iCol, text, nText, xDestroy) {
						...
						try {
							...
							else return util.sqlite3_wasm_db_error(capi.sqlite3_db_handle(pStmt), capi.SQLITE_MISUSE, "Invalid 3rd argument type for sqlite3_bind_text().");
					...
					capi.sqlite3_bind_blob = function f(pStmt, iCol, pMem$1, nMem, xDestroy) {
						...
						try {
							...
							else return util.sqlite3_wasm_db_error(capi.sqlite3_db_handle(pStmt), capi.SQLITE_MISUSE, "Invalid 3rd argument type for sqlite3_bind_blob().");
				...
				capi.sqlite3_config = function(op, ...args) {
					...
					switch (op) {
						...
						case capi.SQLITE_CONFIG_URI: return wasm.exports.sqlite3_wasm_config_i(op, args[0]);
						case capi.SQLITE_CONFIG_LOOKASIDE: return wasm.exports.sqlite3_wasm_config_ii(op, args[0], args[1]);
						case capi.SQLITE_CONFIG_MEMDB_MAXSIZE: return wasm.exports.sqlite3_wasm_config_j(op, args[0]);
			...
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3$1) {
				sqlite3$1.version = {
					...
					"sourceId": "2023-11-01 11:23:50 17129ba1ff7f0daf37100ee82d507aef7827cf38de1866e2633096ae6ad8alt1",
					"downloadVersion": 344e4
				};
			});
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3$1) {
				const toss3 = (...args) => {
					throw new sqlite3$1.SQLite3Error(...args);
				};
				const capi = sqlite3$1.capi;
				const wasm = sqlite3$1.wasm;
				const util = sqlite3$1.util;
				...
				const dbCtorHelper = function ctor(...args) {
					...
					if ("string" !== typeof fn && "number" !== typeof fn || "string" !== typeof flagsStr || vfsName && "string" !== typeof vfsName && "number" !== typeof vfsName) {
						sqlite3$1.config.error("Invalid DB ctor args", opt, arguments);
					...
					try {
						const pVfs = capi.sqlite3_js_db_vfs(pDb$1);
						if (!pVfs) toss3("Internal error: cannot get VFS for new db handle.");
						const postInitSql = __vfsPostOpenSql[pVfs];
						if (postInitSql instanceof Function) postInitSql(this, sqlite3$1);
						else if (postInitSql) checkSqlite3Rc(pDb$1, capi.sqlite3_exec(pDb$1, postInitSql, 0, 0, 0));
					} catch (e) {
						this.close();
						throw e;
					}
				...
				const parseExecArgs = function(db, args) {
					...
					if (opt.callback || opt.resultRows) switch (void 0 === opt.rowMode ? "array" : opt.rowMode) {
						case "object":
							out$1.cbArg = (stmt) => stmt.get(Object.create(null));
							break;
						case "array":
				...
				const bindOne = function f(stmt, ndx, bindType, val) {
					...
					switch (null === val || void 0 === val ? BindTypes.null : bindType) {
						...
						default:
							sqlite3$1.config.warn("Unsupported bind() argument type:", val);
				...
				Stmt.prototype = {
					...
					step: function() {
						...
						switch (rc) {
							...
							default:
								this._mayGet = false;
								sqlite3$1.config.warn("sqlite3_step() rc=", rc, capi.sqlite3_js_rc_str(rc), "SQL =", capi.sqlite3_sql(this.pointer));
					...
					get: function(ndx, asType) {
						...
						switch (void 0 === asType ? capi.sqlite3_column_type(this.pointer, ndx) : asType) {
							...
							case capi.SQLITE_BLOB: {
								...
								const ptr = capi.sqlite3_column_blob(this.pointer, ndx);
				...
				if (util.isUIThread()) {
					sqlite3$1.oo1.JsStorageDb = function(storageName = "session") {
					...
					const jdb = sqlite3$1.oo1.JsStorageDb;
			...
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3$1) {
				sqlite3$1.initWorker1API = function() {
					"use strict";
					const toss = (...args) => {
						throw new Error(args.join(" "));
					};
					if (!(globalThis.WorkerGlobalScope instanceof Function)) toss("initWorker1API() must be run from a Worker thread.");
					const sqlite3$2 = this.sqlite3 || toss("Missing this.sqlite3 object.");
					const DB = sqlite3$2.oo1.DB;
					...
					const wState = {
						...
						close: function(db, alsoUnlink) {
							if (db) {
								...
								const pVfs = sqlite3$2.wasm.sqlite3_wasm_db_vfs(db.pointer, 0);
								db.close();
								const ddNdx = this.dbList.indexOf(db);
								if (ddNdx >= 0) this.dbList.splice(ddNdx, 1);
								if (alsoUnlink && filename && pVfs) sqlite3$2.wasm.sqlite3_wasm_vfs_unlink(pVfs, filename);
							}
						},
					...
					const guessVfs = function(filename) {
						...
						return sqlite3$2.capi.sqlite3_vfs_find(m ? m[2] : 0);
					};
					...
					const wMsgHandler = {
						open: function(ev) {
							...
							if (pVfs) {
								let pMem$1;
								try {
									pMem$1 = sqlite3$2.wasm.allocFromTypedArray(byteArray);
									const rc$1 = sqlite3$2.wasm.sqlite3_wasm_vfs_create_file(pVfs, oargs.filename, pMem$1, byteArray.byteLength);
									if (rc$1) sqlite3$2.SQLite3Error.toss(rc$1);
								} catch (e) {
									throw new sqlite3$2.SQLite3Error(e.name + " creating " + args.filename + ": " + e.message, { cause: e });
								} finally {
									if (pMem$1) sqlite3$2.wasm.dealloc(pMem$1);
								}
							}
							const db = wState.open(oargs);
							rc.filename = db.filename;
							rc.persistent = !!sqlite3$2.capi.sqlite3_js_db_uses_vfs(db.pointer, "opfs");
							rc.dbId = getDbId(db);
							rc.vfs = db.dbVfsName();
							return rc;
						},
						...
						"config-get": function() {
							const rc = Object.create(null);
							const src = sqlite3$2.config;
							["bigIntEnabled"].forEach(function(k) {
								if (Object.getOwnPropertyDescriptor(src, k)) rc[k] = src[k];
							});
							rc.version = sqlite3$2.version;
							rc.vfsList = sqlite3$2.capi.sqlite3_js_vfs_list();
							rc.opfsEnabled = !!sqlite3$2.opfs;
							return rc;
						},
						export: function(ev) {
							const db = getMsgDb(ev);
							const response = {
								byteArray: sqlite3$2.capi.sqlite3_js_db_export(db.pointer),
						...
						"opfs-tree": async function(ev) {
							if (!sqlite3$2.opfs) toss("OPFS support is unavailable.");
							return await sqlite3$2.opfs.treeList();
						}
					};
				...
				}.bind({ sqlite3: sqlite3$1 });
			});
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3$1) {
				const wasm = sqlite3$1.wasm;
				const capi = sqlite3$1.capi;
				const toss = sqlite3$1.util.toss3;
				const vfs = Object.create(null);
				const vtab = Object.create(null);
				const StructBinder = sqlite3$1.StructBinder;
				sqlite3$1.vfs = vfs;
				sqlite3$1.vtab = vtab;
				...
				capi.sqlite3_vfs.prototype.registerVfs = function(asDefault = false) {
					if (!(this instanceof sqlite3$1.capi.sqlite3_vfs)) toss("Expecting a sqlite3_vfs-type argument.");
				...
				const __xWrapFactory = function(methodName, StructType) {
					return function(ptr, removeMapping = false) {
						...
						if (ptr instanceof StructType) {
							...
							return ptr;
						} else if (!wasm.isPtr(ptr)) sqlite3$1.SQLite3Error.toss("Invalid argument to", methodName + "()");
						let rc = this.get(ptr);
				...
				vtab.xError = function f(methodName, err$1, defaultRc) {
					...
					let rc;
					if (err$1 instanceof sqlite3$1.WasmAllocError) rc = capi.SQLITE_NOMEM;
					else if (arguments.length > 2) rc = defaultRc;
					else if (err$1 instanceof sqlite3$1.SQLite3Error) rc = err$1.resultCode;
				...
				vtab.setupModule = function(opt) {
					...
					try {
							...
							const fwrap = function(methodName, func) {
								if (["xConnect", "xCreate"].indexOf(methodName) >= 0) return function(pDb$1, pAux, argc, argv, ppVtab, pzErr) {
									try {
										...
										if (!(e instanceof sqlite3$1.WasmAllocError)) {
						...
						} else installMethods(mod, methods, !!opt.applyArgcCheck);
						if (0 === mod.$iVersion) {
							let v$1;
			...
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3$1) {
				const installOpfsVfs = function callee(options) {
					...
					if (urlParams.has("opfs-disable")) return Promise.resolve(sqlite3$1);
					...
					return new Promise(function(promiseResolve_, promiseReject_) {
						const loggers = [
							sqlite3$1.config.error,
							sqlite3$1.config.warn,
							sqlite3$1.config.log
						];
						...
						const toss = sqlite3$1.util.toss;
						const capi = sqlite3$1.capi;
						const util = sqlite3$1.util;
						const wasm = sqlite3$1.wasm;
						...
						opfsUtil.metrics = {
							dump: function() {
								...
								sqlite3$1.config.log(globalThis.location.href, "metrics for", globalThis.location.href, ":", metrics, "\nTotal of", n, "op(s) for", t, "ms (incl. " + w + " ms of waiting on the async side)");
								sqlite3$1.config.log("Serialization metrics:", metrics.s11n);
						...
						const promiseResolve = () => {
							...
							return promiseResolve_(sqlite3$1);
						};
						...
						const importDbChunked = async function(filename, callback) {
							...
							let sah = await (await hDir.getFileHandle(fnamePart, { create: true })).createSyncAccessHandle();
							let nWrote = 0;
							let chunk;
						...
						if (sqlite3$1.oo1) {
							const OpfsDb = function(...args) {
								const opt = sqlite3$1.oo1.DB.dbCtorHelper.normalizeArgs(...args);
								opt.vfs = opfsVfs.$zName;
								sqlite3$1.oo1.DB.dbCtorHelper.call(this, opt);
							};
							OpfsDb.prototype = Object.create(sqlite3$1.oo1.DB.prototype);
							sqlite3$1.oo1.OpfsDb = OpfsDb;
							OpfsDb.importDb = opfsUtil.importDb;
							sqlite3$1.oo1.DB.dbCtorHelper.setVfsPostOpenSql(opfsVfs.pointer, function(oo1Db, sqlite3$2) {
								sqlite3$2.capi.sqlite3_busy_timeout(oo1Db, 1e4);
								sqlite3$2.capi.sqlite3_exec(oo1Db, ["pragma journal_mode=DELETE;", "pragma cache_size=-16384;"], 0, 0, 0);
							});
						}
				...
				globalThis.sqlite3ApiBootstrap.initializersAsync.push(async (sqlite3$2) => {
					try {
						let proxyJs = installOpfsVfs.defaultProxyUri;
						if (sqlite3$2.scriptInfo.sqlite3Dir) installOpfsVfs.defaultProxyUri = sqlite3$2.scriptInfo.sqlite3Dir + proxyJs;
						return installOpfsVfs().catch((e) => {
							sqlite3$2.config.warn("Ignoring inability to install OPFS sqlite3_vfs:", e.message);
						});
					} catch (e) {
						sqlite3$2.config.error("installOpfsVfs() exception:", e);
			...
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3$1) {
				"use strict";
				const toss = sqlite3$1.util.toss;
				const toss3 = sqlite3$1.util.toss3;
				...
				sqlite3$1.config.log;
				const warn = sqlite3$1.config.warn;
				sqlite3$1.config.error;
				...
				const createOpfsVfs = function(vfsName) {
					if (sqlite3$1.capi.sqlite3_vfs_find(vfsName)) toss3("VFS name is already registered:", vfsName);
				...
				class OpfsSAHPool {
					...
					async removeVfs() {
						...
						try {
							...
							sqlite3$1.config.error(this.vfsName, "removeVfs() failed:", e);
						}
						return true;
					}
					exportFile(name) {
				...
				sqlite3$1.installOpfsSAHPoolVfs = async function(options = Object.create(null)) {
					...
					return initPromises[vfsName] = apiVersionCheck().then(async function() {
						if (options.$testThrowInInit) throw options.$testThrowInInit;
						const thePool = new OpfsSAHPool(options);
						return thePool.isReady.then(async () => {
							const poolUtil = new OpfsSAHPoolUtil(thePool);
							if (sqlite3$1.oo1) {
								const oo1 = sqlite3$1.oo1;
								...
								oo1.DB.dbCtorHelper.setVfsPostOpenSql(theVfs.pointer, function(oo1Db, sqlite3$2) {
									sqlite3$2.capi.sqlite3_exec(oo1Db, ["pragma journal_mode=DELETE;", "pragma cache_size=-16384;"], 0, 0, 0);
								});
							}
			...
			if ("undefined" !== typeof Module$1) {
				const SABC = Object.assign(Object.create(null), {
					exports: "undefined" === typeof wasmExports ? Module$1["asm"] : wasmExports,
					memory: Module$1.wasmMemory
				}, globalThis.sqlite3ApiConfig || {});
				globalThis.sqlite3ApiConfig = SABC;
				let sqlite3$1;
				try {
					sqlite3$1 = globalThis.sqlite3ApiBootstrap();
				} catch (e) {
...
//#endregion
//#region node_modules/@libsql/client-wasm/node_modules/@libsql/libsql-wasm-experimental/sqlite-wasm/jswasm/sqlite3-worker1-promiser-bundler-friendly.js
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
	worker: function() {
		return new Worker("sqlite3-worker1-bundler-friendly.mjs", { type: "module" });
	}.bind({ currentScript: globalThis?.document?.currentScript }),
	onerror: (...args) => console.error("worker1 promiser error", ...args)
};

//#endregion
//#region node_modules/@libsql/client-wasm/node_modules/@libsql/libsql-wasm-experimental/index.mjs
const sqlite3Worker1Promiser = self.sqlite3Worker1Promiser;
var libsql_wasm_experimental_default = sqlite3_bundler_friendly_default;
...
//#endregion
//#region node_modules/@libsql/client-wasm/lib-esm/wasm.js
const sqlite3 = await libsql_wasm_experimental_default();
...
function _createClient(config) {
	...
	if (config.encryptionKey !== void 0) throw new LibsqlError("Encryption key is not supported by the Wasm client.", "ENCRYPTION_KEY_NOT_SUPPORTED");
	...
	config.authToken, config.syncUrl;
...
var Sqlite3Client = class {
	...
	protocol;
	/** @private */
	constructor(sqlite3$1, path, db, intMode) {
		this.#sqlite3 = sqlite3$1;
		this.#path = path;
		this.#db = db;
	...
	async batch(stmts, mode = "deferred") {
		...
		try {
			...
			const resultSets = stmts.map((stmt) => {
				if (!inTransaction(db)) throw new LibsqlError("The transaction has been rolled back", "TRANSACTION_CLOSED");
				return executeStmt(db, stmt, this.#intMode);
			});
			executeStmt(db, "COMMIT", this.#intMode);
			return resultSets;
		} finally {
			if (inTransaction(db)) executeStmt(db, "ROLLBACK", this.#intMode);
		}
	}
	async migrate(stmts) {
		this.#checkNotClosed();
	...
	#getDb() {
		if (this.#db === null) this.#db = new sqlite3.oo1.DB(this.#path, "c");
		return this.#db;
	}
};
var Sqlite3Transaction = class {
	...
	close() {
		if (inTransaction(this.#database)) executeStmt(this.#database, "ROLLBACK", this.#intMode);
	}
	get closed() {
...
function executeStmt(db, stmt, intMode) {
	...
	try {
		...
		else for (const argName in args) {
		...
		if (returnsData) {
			...
			let rows = [];
			for (;;) {
				if (!sqlStmt.step()) break;
				const values = sqlStmt.get([]);
				rows.push(rowFromSql(values, columns, intMode));
			}
			return new ResultSetImpl(columns, columnTypes, rows, 0, void 0);
		} else {
			sqlStmt.step();
			return new ResultSetImpl([], [], [], db.changes(), BigInt(db.lastInsertRowid()));
		}
	} catch (e) {
...
//#endregion
export { createClient };
//# sourceMappingURL=libsql-client-wasm.js.map